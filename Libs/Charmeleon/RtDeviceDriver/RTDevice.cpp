...
{	
	...
	//strcat((char*)Path,(char*)RTLOADER);
	try {
		LibHandle = LoadLibrary(L"RTINST.Dll"); 
	}
	catch (System::Exception^ e){
		throw gcnew System::IO::FileNotFoundException("RTINST.DLL was not found", e);
	}
