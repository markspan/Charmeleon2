/*
Copyright (c) 2012 TMSi B.V.
All rights reserved.

Version=7.2.134.0
Builddate=2013/10/22 11:31:50
...
// NexTus specific
BOOLEAN APIENTRY GetDigSensorId(void *Handle, unsigned int Channel, unsigned int *SensorId );
BOOLEAN APIENTRY GetDigSensorConfig(void *Handle, unsigned int Channel, unsigned int *NrOfChannels, unsigned char *ChanSize, unsigned char *ChanUnit );
BOOLEAN APIENTRY GetDigSensorData(void *Handle, unsigned int Channel, unsigned int *DataSize, unsigned char *SensorData );
BOOLEAN APIENTRY SetDigSensorData(void *Handle, unsigned int Channel, unsigned int GivenDataSizeInBytes, unsigned char *GivenSensorData );
...
typedef BOOLEAN ( __stdcall * PGETDIGSENSORID)(void *Handle, unsigned int Channel, unsigned int *SensorId );
typedef BOOLEAN ( __stdcall * PGETDIGSENSORCONFIG)(void *Handle, unsigned int Channel, unsigned int *NrOfChannels, unsigned char *ChanSize, unsigned char *ChanUnit );
typedef BOOLEAN ( __stdcall * PGETDIGSENSORDATA)(void *Handle, unsigned int Channel, unsigned int *DataSize, unsigned char *SensorData );
typedef BOOLEAN ( __stdcall * PSETDIGSENSORDATA)(void *Handle, unsigned int Channel, unsigned int GivenDataSizeInBytes, unsigned char *GivenSensorData );
